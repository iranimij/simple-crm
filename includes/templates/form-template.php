...
<div class="simple-crm-main-form-wrapper">
    <form action="" class="simple-crm-main-form">
        ...
        <div class="simple-crm-row">
            ...
            <input type="number" required id="phone" name="data[phone]" maxlength="<?php echo esc_attr( $attributes['phone_length'] ) ?>">
        </div>
        <div class="simple-crm-row">
        ...
        <div class="simple-crm-row">
            ...
            <input type="number" required id="desire_budget" name="data[desire_budget]" maxlength="<?php echo esc_attr( $attributes['desire_budget_length'] ) ?>">
        </div>
        <div class="simple-crm-row">
            <label for="message"><?php echo esc_html( $attributes['message_label'] ) ?></label>
            <textarea name="data[message]" id="message" cols="<?php echo esc_attr( $attributes['message_columns'] ) ?>" rows="<?php echo esc_attr( $attributes['message_rows'] ) ?>"></textarea>
        </div>
